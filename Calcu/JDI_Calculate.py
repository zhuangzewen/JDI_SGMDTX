...
def MSG_武将增减伤公式(攻击者, 防御者, 伤害类型: SoulDamageType, 战法类型: SkillType):
    ...
    if 战法类型 == SkillType.主动:
        ...
        普通战法造成伤害提升 = 攻击者.get_普通战法造成伤害提升()
        普通战法造成伤害降低 = 攻击者.get_普通战法造成伤害降低()
        普通战法伤害系数 = 普通战法造成伤害提升 + 普通战法造成伤害降低
        受到普通战法伤害提升 = 防御者.get_受到普通战法伤害提升()
        受到普通战法伤害降低 = 防御者.get_受到普通战法伤害降低()
        受到普通战法伤害系数 = 受到普通战法伤害提升 + 受到普通战法伤害降低
        武将增减伤系数 *= (普通战法伤害系数 * 受到普通战法伤害系数)
