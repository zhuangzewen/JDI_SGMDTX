...
def battle():
    ...
    team1_hero2 = get_hero_info(Generals_Name_Enum.荀攸)
    ...
    team2_hero2 = get_hero_info(Generals_Name_Enum.荀攸)
    ...
    team2_hero3 = get_hero_info(Generals_Name_Enum.诸葛亮)
    ...
    team1 = TeamInfo(Formation.锥型阵, team1_hero1, team1_hero2, team1_hero3, '诸葛队')
    team2 = TeamInfo(Formation.锥型阵, team2_hero1, team2_hero2, team2_hero3, '夫人队')
