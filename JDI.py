...
def battle():
    ...
    team1_hero1 = get_hero_info(Generals_Name_Enum.甘夫人)
    ...
    team1_hero2 = get_hero_info(Generals_Name_Enum.貂蝉)
    ...
    team1_hero3 = get_hero_info(Generals_Name_Enum.蔡文姬)
    ...
    team2_hero1.set_skills(Fitting_List_Enum.青囊急救, 0, None, 0)
    ...
    team1 = TeamInfo(Formation.一字阵, team1_hero1, team1_hero2, team1_hero3, '测试队伍A_普攻测试队')
