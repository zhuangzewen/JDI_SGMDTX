...
class Soul():
    ...
    def deploy_initial(self):
        ...
        if self.effect_type == SoulEffectType.造成伤害:
            ...
            Log().battle_L0('        [{}]的【造成伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【对前排造成伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【受到伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【受到谋略伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(real_value) * 100,  cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【武力】{}{:.2f}({:.2f})'.format(heroName, show_upEffect_name, abs(self.effect_value), cur_value))
            if self.effect_value < 0 and self.sourceType != SoulSourceType.负面状态效果:
                self.battleField.respond(status=SoulResponseTime.施加负面时, 时机响应武将=self.initiator, 溯源SOUL=self)
                self.battleField.respond(status=SoulResponseTime.被施加负面时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            Log().battle_L0('        [{}]的【智力】{}{:.2f}({:.2f})'.format(heroName, show_upEffect_name, abs(self.effect_value), cur_value))
            if self.effect_value < 0 and self.sourceType != SoulSourceType.负面状态效果:
                self.battleField.respond(status=SoulResponseTime.施加负面时, 时机响应武将=self.initiator, 溯源SOUL=self)
                self.battleField.respond(status=SoulResponseTime.被施加负面时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            Log().battle_L0('        [{}]的【统帅】{}{:.2f}({:.2f})'.format(heroName, show_upEffect_name, abs(self.effect_value), cur_value))
            if self.effect_value < 0 and self.sourceType != SoulSourceType.负面状态效果:
                self.battleField.respond(status=SoulResponseTime.施加负面时, 时机响应武将=self.initiator, 溯源SOUL=self)
                self.battleField.respond(status=SoulResponseTime.被施加负面时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            Log().battle_L0('        [{}]的【先攻】{}{:.2f}({:.2f})'.format(heroName, show_upEffect_name, abs(self.effect_value), cur_value))
            if self.effect_value < 0 and self.sourceType != SoulSourceType.负面状态效果:    
                self.battleField.respond(status=SoulResponseTime.施加负面时, 时机响应武将=self.initiator, 溯源SOUL=self)
                self.battleField.respond(status=SoulResponseTime.被施加负面时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            Log().battle_L0('        [{}]的【攻心】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【连击几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【闪避几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(real_value) * 100, cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【会心几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【会心伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            if self.effect_value < 0 and self.sourceType != SoulSourceType.负面状态效果:
                self.battleField.respond(status=SoulResponseTime.施加负面时, 时机响应武将=self.initiator, 溯源SOUL=self)
                self.battleField.respond(status=SoulResponseTime.被施加负面时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            Log().battle_L0('        [{}]的【奇谋几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            ...
            Log().battle_L0('        [{}]的【奇谋伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            if self.effect_value < 0 and self.sourceType != SoulSourceType.负面状态效果:
                self.battleField.respond(status=SoulResponseTime.施加负面时, 时机响应武将=self.initiator, 溯源SOUL=self)
                self.battleField.respond(status=SoulResponseTime.被施加负面时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[清醒]效果已刷新'.format(heroName))
            else:
                Log().battle_L0('        [{}]的[清醒]效果已施加'.format(heroName))
            ...
            Log().battle_L0('        [{}]的【受治疗效果】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(self.effect_value) * 100, cur_value * 100))
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[震慑]效果已刷新'.format(heroName))
            else:
                Log().battle_L0('        [{}]的[震慑]效果已施加'.format(heroName))
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[缴械]效果已刷新'.format(heroName))
            else:
                Log().battle_L0('        [{}]的[缴械]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加控制时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加控制时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[技穷]效果已刷新'.format(heroName))
            else:
                Log().battle_L0('        [{}]的[技穷]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加控制时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加控制时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[混乱]效果已刷新'.format(heroName))
            else:
                Log().battle_L0('        [{}]的[混乱]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加控制时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加控制时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[嘲讽]效果已刷新'.format(heroName))
            else:
                Log().battle_L0('        [{}]的[嘲讽]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加控制时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加控制时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[虚弱]效果已刷新'.format(heroName))
            else:
                Log().battle_L0('        [{}]的[虚弱]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加控制时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加控制时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[断粮]效果已刷新'.format(heroName))
            else:
                Log().battle_L0('        [{}]的[断粮]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加控制时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加控制时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[洪水]效果已刷新'.format(heroName))
            else:
                ...
                Log().battle_L0('        [{}]的[洪水]效果已施加'.format(heroName))
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[火攻]效果已刷新'.format(heroName))
            else:
                ...
                Log().battle_L0('        [{}]的[火攻]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加异常时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加异常时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[风暴]效果已刷新'.format(heroName))
            else:
                ...
                Log().battle_L0('        [{}]的[风暴]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加异常时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加异常时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[畏惧]效果已刷新'.format(heroName))
            else:
                ...
                Log().battle_L0('        [{}]的[畏惧]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加异常时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加异常时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if is存在同类状态:
                Log().battle_L0('        [{}]的[妖术]效果已刷新'.format(heroName))
            else:
                ...
                Log().battle_L0('        [{}]的[妖术]效果已施加'.format(heroName))
            self.battleField.respond(status=SoulResponseTime.施加异常时, 时机响应武将=self.initiator, 溯源SOUL=self)
            self.battleField.respond(status=SoulResponseTime.被施加异常时, 时机响应武将=self.target, 溯源SOUL=self)
            ...
            if (self.skill and self.skill.get_战法名称() == Fitting_List_Enum.普攻):
                Log().battle_L0('        [{}]损失了兵力{}({})'.format(heroName, abs(伤害数值), 剩余兵力))
            else:
                if 伤害来源Soul效果 == '':
            ...
            if 剩余兵力 <= 0:
                Log().battle_L0('        [{}]兵力为0 无法再战'.format(heroName))
            ...
            for soul in self.target.get_响应Soul列表():
                ...
                if soul.effect_type == SoulEffectType.断粮:
                    Log().battle_L0('        [{}]由于[{}]【{}】的[断粮]效果治疗效率降为30%'.format(self.target.get_武将名称().value, soul.initiator.get_武将名称().value, soul.skill.get_战法名称().value))
                    恢复兵力 = int(恢复兵力 * 0.7)
                    break
            ...
            Log().battle_L0('        [{}]恢复了兵力{}({})'.format(self.target.get_武将名称().value, 恢复兵力, self.target.get_兵力()))
    ...
    def restore_initial(self):
        ...
        if self.effect_type == SoulEffectType.造成伤害:
            ...
            Log().battle_L0('        [{}]的【受到伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(real_value) * 100,  ori_value * 100))
            ...
            Log().battle_L0('        [{}]的【受到谋略伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(real_value) * 100,  ori_value * 100))
            ...
            Log().battle_L0('        [{}]的【闪避几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(real_value) * 100, ori_value * 100))
            ...
            msg_移除响应(self)
            Log().battle_L0('        [{}]的【清醒】效果已消失'.format(heroName))
            ...
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[震慑]效果已消失'.format(heroName))

        elif self.effect_type == SoulEffectType.缴械:
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[缴械]效果已消失'.format(heroName))

        elif self.effect_type == SoulEffectType.技穷:
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[技穷]效果已消失'.format(heroName))

        elif self.effect_type == SoulEffectType.混乱:
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[混乱]效果已消失'.format(heroName))

        elif self.effect_type == SoulEffectType.嘲讽:
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[嘲讽]效果已消失'.format(heroName))

        elif self.effect_type == SoulEffectType.虚弱:
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[虚弱]效果已消失'.format(heroName))

        elif self.effect_type == SoulEffectType.断粮:
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[断粮]效果已消失'.format(heroName))

        elif self.effect_type == SoulEffectType.洪水:
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[洪水]效果已消失'.format(heroName))
            统帅soul = Soul(target=self.target, 
                                    sourceType=SoulSourceType.负面状态效果, 
                                    skill=self.skill,
                                    effect_type=SoulEffectType.统帅, 
            ...
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[火攻]效果已消失'.format(heroName))
            ...
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[风暴]效果已消失'.format(heroName))
            ...
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[畏惧]效果已消失'.format(heroName))
            ...
            msg_移除响应(self)
            Log().battle_L0('        [{}]的[妖术]效果已消失'.format(heroName))
