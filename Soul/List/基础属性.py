...
def deploy_武力_initial(soul: Any):
    ...
    Log().battle_L2('[{}]的【武力】{}{:.2f}({:.2f})'.format(heroName, show_upEffect_name, abs(soul.effect_value), cur_value))
    return True
...
def deploy_智力_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【智力】{}{:.2f}({:.2f})'.format(heroName, show_upEffect_name, abs(soul.effect_value), cur_value))
    return True
...
def deploy_统率_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【统率】{}{:.2f}({:.2f})'.format(heroName, show_upEffect_name, abs(soul.effect_value), cur_value))
    return True
...
def deploy_先攻_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【先攻】{}{:.2f}({:.2f})'.format(heroName, show_upEffect_name, abs(soul.effect_value), cur_value))
    return True
