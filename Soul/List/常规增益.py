...
def deploy_会心几率_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【会心几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def restore_会心几率_initial(soul: Any):
    ...
    cur_value -= soul.effect_value
    setattr(hero, HeroInfoKey.会心几率.value, cur_value)
    show_upEffect_name = '降低' if soul.effect_value > 0 else '提升'
    Log().battle_L2('[{}]的【会心几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_会心伤害_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【会心伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_奇谋几率_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【奇谋几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_奇谋伤害_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【奇谋伤害】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_破甲_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【破甲】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_看破_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【看破】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_倒戈_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【倒戈】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_攻心_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【攻心】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_连击几率_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【连击几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_反击几率_initial(soul: Any):
    ...
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【反击几率】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
...
def deploy_规避_initial(soul: Any):
    ...
    effect_value = soul.effect_value * (1 - cur_value)
    soul.effect_value = effect_value
    cur_value += effect_value
    setattr(hero, HeroInfoKey.规避.value, cur_value)
    show_upEffect_name = '提升' if soul.effect_value > 0 else '降低'
    Log().battle_L2('[{}]的【规避】{}{:.2f}%({:.2f}%)'.format(heroName, show_upEffect_name, abs(soul.effect_value) * 100, cur_value * 100))
    return True
